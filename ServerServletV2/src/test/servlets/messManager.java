...
public class messManager extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        File file = new File("/opt/bitnami/apache-tomcat/logs/Users/" + request.getHeader("Username") +"/message.gif");
        if (file.exists()) {
            ...
            out.println("<html><body><h1 align='center'>"
                    + "Why are you looking at me? This is a communication servlet, not a website.</h1> </body></html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        TextConverter tc = new TextConverter("jpeg", currDir);
        //Check if anything was properly read out of the request
        out.write(request.getServletContext().getRealPath("/"));
        if (message == null) {
        ...
        try {
        	...
        	try {
        		tc.toImage(message, destination, out);
        	}catch(Throwable c) {
