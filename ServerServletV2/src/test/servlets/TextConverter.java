...
//should be bmp, jpeg, or png
    ...
    public TextConverter(String type, String dir){
        fileType = type;
        currDir = dir;
    ...
    public void toImage(String message, String saveLocation, PrintWriter out) throws IOException {

        File directory = new File("/opt/bitnami/apache-tomcat/webapps/ServerServletV2/Users");
        if (! directory.exists()){
            directory.mkdir();
            out.write("Directory didn't exist. Making it now.    ");
            // If you require it to make the entire directory path including parents,
            // use directory.mkdirs(); here instead.
        }
        File dir2 = new File("/opt/bitnami/apache-tomcat/webapps/ServerServletV2/Users/" + saveLocation);
        if (! dir2.exists()){
        	dir2.mkdir();
            out.write("Directory didn't exist. Creating now.    ");
            // If you require it to make the entire directory path including parents,
            // use directory.mkdirs(); here instead.
        }
        ...
        File newFile = new File("/opt/bitnami/apache-tomcat/webapps/ServerServletV2/Users/"    + saveLocation + "/" + fileName + "." + fileType);
        ...
        for(int j = 0; j < 5; j++){
            BufferedImage img = ImageIO.read(new File("/opt/bitnami/apache-tomcat/webapps/ServerServletV2/Users/" + saveLocation + "/baseImage." + fileType));
            ...
            try{
                ImageIO.write(img, "jpeg",  new FileImageOutputStream(new File("/opt/bitnami/apache-tomcat/webapps/ServerServletV2/Users/" + saveLocation + "/redrawn" + j + "." + fileType)));
        ...
        String[] args = new String[]{"python","/opt/bitnami/apache-tomcat/webapps/ServerServletV2/WEB-INF/classes/test/servlets/makeGif.py", "/opt/bitnami/apache-tomcat/webapps/ServerServletV2/Users/" + saveLocation};
    ...
    public void scrubFiles(String username){
        String path = "/opt/bitnami/apache-tomcat/webapps/ServerServletV2/Users/" + username;
